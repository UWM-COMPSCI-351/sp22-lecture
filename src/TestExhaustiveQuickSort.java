...
public class TestExhaustiveQuickSort extends TestCase {
  ...
  protected void setUp() {
    ...
    su = new SortUtils<String>(new Comparator<String> () {
    	public int compare(String s1, String s2) {
    		return s1.compareTo(s2);
    	}
    });
    
    su = new SortUtils<>((String s1, String s2) -> { return s1.compareTo(s2); } ) ; // shorter for same thing

    su = new SortUtils<>((s1,s2) -> s1.compareTo(s2)); // even shorter for same thing
	
    su = new SortUtils<>(String::compareTo); // shortest for same thing
   }
